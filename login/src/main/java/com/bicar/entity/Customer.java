...
public class Customer {
	...
	public Customer(int custid, String name, int age, long mobile, String address, long primary_id, long cust_type,
			String email, String company_name, int rating, int pincode) {
		super();
		this.custid = custid;
		this.name = name;
		this.age = age;
